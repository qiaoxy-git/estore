...
<body>
	...
	<div class="content">
		<div class="contentCenter">
			...
			<form action="after/order" name="orderForm" method="get">
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach items="${address}" var="ad">
									<li><input type="radio" checked="checked" name="shipAddId" value="${ad.id}"
										style="width: 50px">
										${ad.receivename}&nbsp;&nbsp;&nbsp;${ad.phone}&nbsp;&nbsp;&nbsp;${ad.address}</li>
								</c:forEach>
							</c:otherwise>
						</c:choose>
					</ul>
				...
				<p class="singleP">
					<b>送货清单</b><span><a href="after/shopCart.jsp">返回修改购物车</a></span>
				</p>
				<div class="bigDiv">
					<div class="twoDiv">
						<b>商家：briup自营</b>
						
						<c:forEach items="${cart.lines }" var="ca">
						<ul class="oneUL">
							<li><img src="images/viewBook.png" class="pic">
								<p>${ca.book.description}&nbsp;&nbsp;${ca.book.name}&nbsp;&nbsp;</p>
								<p>
									<font>${ca.book.price }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${ca.num}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货
								</p>
								<p>
				...
				<div class="money">
					...
					<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥18</span>

					<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${cart.cost + 18}</span>
				</div>
				<div class="submit">
					<span>应付金额：<font>¥${cart.cost + 18}</font><input type="image"
