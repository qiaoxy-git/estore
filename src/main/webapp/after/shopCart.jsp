...
<!--中间部分div-->
<div class="empty">
	<div class="peisong"><pre>全部商品  ${cart.size} </pre></div>
	<div class="mainCenter">
		...
		<div class="mainPro">
			...
			<c:forEach items="${cart.lines}" var="ca" varStatus="status">
            ...
            <form>
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td class="index2">
                                <input type="text" name="num" value="${ca.num }"><br>
                                <span>有货</span>
                            </td>
                            <td>
                                <span>¥${ca.cost}</span>
                ...
                <div class="allButtom">
                    <a href="after/confirm" class="caozuo">去提交</a>
                    <span>已选择<font>${cart.size}</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价不含运费：<font>¥${cart.cost}</font></span>
                </div>
