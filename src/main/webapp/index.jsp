		...
		<div class="h3_center">
			...
			<p>
				<c:forEach items="${applicationScope.categories}" var="ca">
					<a href="serach?id=${ca.id}">${ca.name}</a>|
            </c:forEach>
			</p>
		</div>
		<div class="h3_right">
			...
			<div class="c3_b1_left">
				...
				<c:forEach var="ca" items="${applicationScope.categories }">
					<dd>
						<h1>${ca.name}</h1>
						<p>
							<c:forEach items="${ca.categorise}" var="tt">
			...
			<div class="c3_b1_center">
				...
				<div class="c3_b1_c_bottom">
					<ul>
						...
						<li><a href="view?id=${book.id}"><img src="images/p01.png" /></a>
							<a href="view?id=${book.id}">${book.name}</a></li>
							</c:forEach>
					</ul>
				</div>
			</div>
